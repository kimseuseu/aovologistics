  ...
  const values = [
    {
      ...
      title: "초기 비용 0원",
      desc: "수천만 원의 장비 구매 비용 없이 월 구독료만으로 즉시 도입합니다.",
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
      ...
      title: "올인원 유지보수",
      desc: "정기 점검, 부품 교체, 긴급 수리까지 구독료에 전부 포함되어 있습니다.",
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
      ...
      title: "자유로운 교체",
      desc: "사업 규모에 맞춰 언제든 장비를 추가하거나 최신 장비로 교체할 수 있습니다.",
    },
  ];
  ...
  const categories = [
    {
      tab: "장비",
      items: [
        { title: "지게차", desc: "전동·디젤·LPG — 1t부터 5t까지 풀라인업 보유", tag: "Forklift", icon: "M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 00-3.213-9.193 2.056 2.056 0 00-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 00-10.026 0 1.106 1.106 0 00-.987 1.106v7.635m12-6.677v6.677m0 4.5v-4.5m0 0h-12" },
        { title: "컨베이어", desc: "벨트·롤러·체인 — 현장 맞춤형 설계 지원", tag: "Conveyor", icon: "M6 12L3.269 3.126A59.768 59.768 0 0121.485 12 59.77 59.77 0 013.27 20.876L5.999 12zm0 0h7.5" },
        { title: "보관장비", desc: "중량·경량·이동식 — 공간 효율 극대화 랙 시스템", tag: "Storage", icon: "M20.25 7.5l-.625 10.632a2.25 2.25 0 01-2.247 2.118H6.622a2.25 2.25 0 01-2.247-2.118L3.75 7.5M10 11.25h4M3.375 7.5h17.25c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125z" },
        { title: "포장장비", desc: "박스포장기·랩핑기 — 자동화 라인 구축", tag: "Packaging", icon: "M21 7.5l-2.25-1.313M21 7.5v2.25m0-2.25l-2.25 1.313M3 7.5l2.25-1.313M3 7.5l2.25 1.313M3 7.5v2.25m9 3l2.25-1.313M12 12.75l-2.25-1.313M12 12.75V15m0 6.75l2.25-1.313M12 21.75V19.5m0 2.25l-2.25-1.313m0-16.875L12 2.25l2.25 1.313M21 14.25v2.25l-2.25 1.313m-13.5 0L3 16.5v-2.25" },
      ],
    },
    {
      tab: "서비스",
      items: [
        { title: "정기 유지보수", desc: "월간 정기 점검과 부품 교체를 구독료에 포함 제공", tag: "Maintenance", icon: "M11.42 15.17l-5.1-5.1m0 0L3.14 12.9a.75.75 0 000 1.06l5.1 5.1m-5.1-5.1h11.48m0 0l2.17-2.83a.75.75 0 000-.94l-2.17-2.83M16.9 10.07h3.36a.75.75 0 01.75.75v2.36a.75.75 0 01-.75.75H16.9" },
        { title: "긴급 출동", desc: "24시간 전국 긴급 출동 — 평균 2시간 이내 도착", tag: "Emergency", icon: "M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z" },
        { title: "전담 매니저", desc: "비즈니스 플랜 이상 — 전담 매니저가 직접 관리", tag: "Manager", icon: "M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" },
        { title: "실시간 대시보드", desc: "장비 상태, 가동률, 점검 이력 실시간 모니터링", tag: "Dashboard", icon: "M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 3m8.5-3l1 3m0 0l.5 1.5m-.5-1.5h-9.5m0 0l-.5 1.5m.75-9l3-3 2.148 2.148A12.061 12.061 0 0116.5 7.605" },
      ],
    },
  ];
